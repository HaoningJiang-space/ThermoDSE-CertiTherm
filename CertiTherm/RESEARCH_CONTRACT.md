...
# Archived pre-DSOS research contract

> Superseded on 2026-07-21 by `docs/INFORMATION_THEORETIC_METHOD.md` and
> `docs/HELDOUT_PROTOCOL.md`. This file records the historical G1–G4 contract;
> its 3D-ICE replay and G4 policy claims are not active paper evidence. The
> runnable historical snapshot is Git tag `legacy-g1-g4-archived`.
