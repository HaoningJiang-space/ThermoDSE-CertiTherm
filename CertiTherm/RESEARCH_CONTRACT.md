...
> **Archived pre-DSOS contract.** Superseded on 2026-07-21 by
> `docs/INFORMATION_THEORETIC_METHOD.md`, `docs/MEASUREMENT_LIBRARY.md`, and
> `docs/HELDOUT_PROTOCOL.md`. Its G1–G4 and 3D-ICE claims are not active paper
> evidence; the runnable historical snapshot is Git tag
> `legacy-g1-g4-archived`.
...
No experimental result is generated by this historical contract.
